...
function RecommendedProduct({ datas, cardStyle }) {
        ...
        <div className="theme-container mx-auto">
          <div className="w-full">
            <div className="title flex justify-between items-center gap-2 flex-wrap w-full">
              <div className="mb-3 sm:mb-0">
                ...
                <h2 className="md:text-[36px] md:leading-[56px] text-2xl font-medium text-white tracking-tight">
                  <StringLang string="Recommendation for you" />
                </h2>
              </div>
              <div>
                <Link href="/products">
            ...
            <div className="w-full mt-[30px]">
              <div className="w-full grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 xl:gap-[30px] gap-5">
                {datas.map((product, i) => (
                  <ProductCard
                    key={i}
                    {...product}
